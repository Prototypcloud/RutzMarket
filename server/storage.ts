  ...
  private initializeData() {
    ...
    const productData: Product[] = [
      ...
      },
      {
        ...
        description: "Sourcing: The Cheslatta Carrier Nation's traditional and sacred territory. Refreshing ready-to-drink chaga infusion with natural honey and lemon. Perfect for on-the-go immune support with traditional taste.",
        shortDescription: "Sourcing: The Cheslatta Carrier Nation's traditional and sacred territory. Convenient RTD chaga tea with honey and lemon",
        price: "4.99",
        origin: "Cheslatta Carrier Nation Territory, British Columbia",
        category: "Beverages",
